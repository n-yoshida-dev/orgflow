...
erDiagram
  ...
  INTERNAL_ORGANIZATION_MEMBERSHIP ||--o{ INTERNAL_ORGANIZATION_MEMBERSHIP_ROLES : 付与された業務ロールを持つ
  INTERNAL_ORGANIZATION_ROLE ||--o{ INTERNAL_ORGANIZATION_MEMBERSHIP_ROLES : 所属に付与される
